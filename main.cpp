...
int main(int argc, char **argv)
{
    ...
    GRRLIB_InitTileSet(projectile_img,32,32,0);
	...
	while(1)
	{
		...
		if (menu_bool) {
            ...
            if (states["A"]) projectiles.push_back(new Projectile(perso.donnees->m_x,perso.donnees->m_y, ir.x, ir.y, projectile_img));
